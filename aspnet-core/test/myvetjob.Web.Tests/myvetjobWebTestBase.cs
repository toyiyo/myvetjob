...
{
    public abstract class myvetjobWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static myvetjobWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(myvetjobWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<myvetjobDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<myvetjobDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<myvetjobDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<myvetjobDbContext, Task<T>> func)
        {
            T result;
