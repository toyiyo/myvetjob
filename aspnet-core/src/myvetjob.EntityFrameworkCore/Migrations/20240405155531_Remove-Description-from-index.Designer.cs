...
namespace myvetjob.Migrations
{
    ...
    [Migration("20240405155531_Remove-Description-from-index")]
    partial class RemoveDescriptionfromindex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("myvetjob.Jobs.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CompanyName", "Position", "JobLocation", "OrderStatus");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("myvetjob.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("myvetjob.Authorization.Users.User", null)
                        .WithMany("Claims")
